...
const GAMES = ['hangman','memory','ttt','connect4','wordle','minesweeper','sudoku',
  ...
  'dotsboxes','blockblast','digquest','hanoi','blackjack','crazy8','geometrydash','platformer','maze','perfectcircle','crossyroad','anagrams','nonogram','eightball','trivia','farm','set'];
